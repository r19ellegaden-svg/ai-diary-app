        ...
        with st.spinner("Geminiが日記を読んでいます..."):
            try:
               ...
               prompt = f"""あなたは一流の思考ログ・コーチです。ユーザーのアウトプット力を高めるため、以下の3点に絞って日記を厳しく査定し、フィードバックしてください。
                            1. 具体性の欠如を指摘：「楽しかった」「頑張った」などの抽象的な表現があれば、具体的に何がどうだったのかを問い詰めてください。
                            2. 学びの言語化：その出来事から得た「教訓」や「次に活かせるアクション」が書かれているかを評価してください。
                            3. 改善アドバイス：アウトプットの質を上げるための具体的な修正案を1つ提示してください。
